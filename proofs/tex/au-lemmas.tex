...
\begin{lemma}[Soundness of Anti-Unification] \label{lemma:au-soundness}
    \hfill
    \begin{itemize}
        \item [$+$]  Assuming $[[iP1]]$ and $[[iP2]]$ are normalized,
        if $[[Γ ⊨ iP1 ≈au iP2 ⫤ (Ξ, uQ, aus1, aus2)]]$
...
\begin{lemma}[Completeness of Anti-Unification] \label{lemma:au-completeness}
    \hfill
    \begin{itemize}
        \item [$+$] 
...
\begin{lemma}[Initiality of Anti-Unification] \label{lemma:au-initial}
    \hfill
    \begin{itemize}
        \item [$+$] 
            Assume that $[[iP1]]$ and $[[iP2]]$ are normalized, and
