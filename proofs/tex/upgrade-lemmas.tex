...
\begin{proof}
    ...
    by \cref{todo}, get $[[Δ, pnas, pncs ⊢ [pnas/pnbs]iQ ≥ iP]]$.
    Notice that $[[Δ ⊢ iQ]]$ implies that $[[fv iQ ∩ {pnbs} = ∅]]$, 
    then by \cref{todo}, $[[ [pnas/pnbs]iQ = iQ]]$, and thus $[[Δ, pnas, pncs ⊢ iQ ≥ iP]]$.
...
\begin{proof}
    ...
    \cref{todo}, since $[[iQ']]$ is well-formed in $[[Δ]]$, simplifies to 
     $[[Δ, pnbs ⊢ iQ' ≥ [pnbs/pnas]iP]]$.
