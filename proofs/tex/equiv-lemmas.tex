...
\begin{lemma}[Normalization preserves substitution signature]
...
\begin{corollary}[Algorithmic substitution equivalence becomes equality after normalization]
  \label{corollary:subst-subt-equiv-algorithmization}
  Suppose that $[[Θ ⊢ uσ1 : Ξ']]$ and $[[Θ ⊢ uσ2 : Ξ']]$ are algorithmic substitutions
  and $[[Ξ ⊆ Ξ']]$. 
  Then $[[Γ ⊢ uσ1 ≈ uσ2 : Ξ]] \iff [[nf(uσ1)|Ξ = nf(uσ2)|Ξ]]$.
\end{corollary}
