\begin{lemma}[Algorithmic Substitution Strengthening]
...
\begin{lemma}[Substitutions equal on the algorithmic variables]
...
\begin{corollary}[Substitutions equivalent on the algorithmic variables]
