...
\begin{proof}
  ...
  \begin{caseof}
    ...
    iQ2 = iQ']]$, and thus, \ruleref{\ottdruleLUBExistsLabel} is applicable.
...
\begin{lemma}[Initiality of the Least Upper Bound]
  For normalized types $[[Γ ⊢ iP1]]$, $[[Γ ⊢ iP2]]$, and $[[Γ ⊢ iQ]]$
  such that $[[Γ ⊢ iQ ≥ iP1]]$ and $[[Γ ⊢ iQ ≥ iP2]]$,
...
\begin{proof}
  ...
  \item $[[iP1]] = [[↓iM1]]$ and $[[iP2]] = [[↓iM2]]$\\
    ...
    % G,· ⊨ ↓iN ≈au ↓iM ⫤ (Ξ, uP, aus1, aus2)
    % -------------------------------------------------- :: Shift
    % G ⊨ ↓iN ∨ ↓iM = ∃nas.[nas / ToList Ξ]uP
