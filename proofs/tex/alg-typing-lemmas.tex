...
\begin{lemma}[Soundness of typing] \label{lemma:typing-soundness}
    ...
    \begin{itemize}
        ...
        \item  For $[[Γ ⊢ Θ]]$ and $[[Γ; dom(Θ) ⊢  uN]]$ free from negative metavariables,
            ...
            \begin{enumerate}
                ...
                \item $[[Θ' ⊢ SC]]$
                \item for any $[[(Θ'  ⊢  SC) ⊢ uσ]]$, we have $[[ Γ ; Φ ⊢ [uσ]uN ● args ⇒> [uσ]uM ]]$
            \end{enumerate}
    \end{itemize}
\end{lemma}
\begin{proof}
    ...
    \begin{caseof}
        ...
        \item \ruleref{\ottdruleATAppLetAnnLabel}
            ...
            we have $[[Θ ⊢ SC]]$. Let us take $[[uσ]]$ such that $[[(Θ  ⊢  SC) ⊢ uσ]]$
            ...
            \begin{enumerate}
                ...
                \item $[[Γ; dom(Θ) ⊢  ↑uQ]]$,
                \item $[[Θ' ⊢ SC1]]$,
                \item for any $[[(Θ'  ⊢  SC1) ⊢ uσ]]$, we have $[[ Γ ; Φ ⊢ [uσ]uM ● args ⇒> [uσ]↑uQ ]]$.
        ...
        \item \ruleref{\ottdruleATAppLetLabel}
            ...
            \begin{enumerate}
                ...
                \item $[[Γ; dom(Θ) ⊢  ↑uQ]]$
                \item $[[Θ ⊢ SC]]$
                \item for any $[[(Θ  ⊢  SC) ⊢ uσ]]$, we have $[[ Γ ; Φ ⊢ [uσ]uM ● args ⇒> [uσ]↑uQ ]]$, 
            ...
            \begin{itemize}
                ...
                \item Let us take an arbitrary substitution $[[uσ]]$ 
                    satisfying $[[(Θ  ⊢  SC) ⊢ uσ]]$ (it exists by \cref{lemma:constraint-sat}).
                ...
                \item To show the uniqueness of $[[↑[uσ]uQ]]$,
                    ...
                    \begin{enumerate}
                        ...
                        \item there exists a substitution $(Θ'  ⊢ SC') ⊢ uσ'$ such that
                            $[[Γ ⊢ [uσ']uN' ≈ iK]]$.
                    \end{enumerate}
        ...
        \item \ruleref{\ottdruleATArrowAppLabel} 
                ...
                \item $[[Γ; Φ; Θ ⊨ uQ → uN ● v , args ⇒> uM ⫤ Θ'; SC]]$, 
                    ...
                    \begin{enumerate}
                        ...
                        \item $[[Γ; Θ ⊨ uQ ≥ iP ⫤ SC1]]$,
                            ...
                            $[[Θ ⊢ SC]]$ and
                            for any $[[(Θ  ⊢  SC1) ⊢ uσ]]$, we have $[[Γ ⊢ [uσ]uQ ≥ iP]]$;
            ...
            \begin{enumerate}
                ...
                \begin{enumerate}
                    \item $[[Θ' ⊢ SC1]]$,
                    \item for any $[[(Θ'  ⊢  SC) ⊢ uσ]]$, $[[(Θ'  ⊢  SCi) ⊢ uσ]]$ holds;
                \end{enumerate}
                \item suppose that $[[(Θ'  ⊢  SC) ⊢ uσ]]$. Then to 
                    ...
                    \begin{enumerate}
                        ...
                        \item $[[Γ ⊢ [uσ]uQ ≥ iP]]$ holds by the soundness of subtyping 
                            as noted above,
                            since $[[(Θ'  ⊢  SC) ⊢ uσ]]$ implies $[[(Θ  ⊢  SC1) ⊢ uσ]]$.
                        \item $[[Γ; Φ ⊢ [uσ]uN ● args ⇒> [uσ]uM]]$ holds by the induction hypothesis
                            as shown above,
                            since $[[(Θ'  ⊢  SC) ⊢ uσ]]$ implies $[[(Θ'  ⊢  SC2) ⊢ uσ]]$.
                    \end{enumerate}
            \end{enumerate}
            ...
            \begin{enumerate}
                ...
                \item $[[Γ; Φ; Θ ⊨ ∀pas.uN ● args ⇒> uM ⫤ Θ'; SC]]$, which by inversion means
                    ...
                    \begin{enumerate}
                        ...
                        \item $[[Γ; dom(Θ') ⊢  uM]]$ is normalized and free from negative metavariables,
                        \item $[[Θ' ⊢ SC]]$,
                        \item for any $[[(Θ'  ⊢  SC) ⊢ uσ]]$, we have $[[ Γ ; Φ ⊢ [uσ][â⁺*/pas]uN ● args ⇒> [uσ]uM ]]$.
                    \end{enumerate}
            \end{enumerate}
...
\begin{lemma}[Completeness of Typing]
    ...
    \begin{itemize}
        ...
        \item [$\bullet$] Suppose that 
            ...
            $[[Γ ⊢ Θ]]$,
            $[[Γ; dom(Θ) ⊢  uN]]$ (free from negative metavariables, that is $[[α̂⁻]] \notin [[uv uN]]$), 
            $[[Θ ⊢ uσ]]$, and $[[Γ ⊢ iM]]$. Then
...
\begin{proof}
    ...
    \begin{caseof}
                ...
                \item $[[Γ ; Φ ⊢ iM ● args ⇒> ↑iQ]]$. 
                    ...
                    \begin{enumerate}
                        ...
                        \item for any $[[Γ ⊢ iM'']]$ 
                            ...
                            $[[(Θ  ⊢ SC1) ⊢ uσ0]]$ such that $[[Γ ⊢ [uσ0]uM' ≈ ↑iQ]]$.
        ...
        \item \ruleref{\ottdruleDTArrowAppLabel}\\
                ...
                \item $[[Γ; Φ ⊢ [uσ](uQ → uN1) ● v, args ⇒> iM]]$, 
                    ...
                    \begin{enumerate}
                        ...
                        \item $[[Γ ⊢ [uσ]uQ ≥ iP]]$, 
                            ...
                            $[[ Γ; Θ ⊨ uQ ≥ iP' ⫤ SC1 ]]$, 
                            for some $[[Θ ⊢ SC1]]$, and moreover, $[[(Θ  ⊢  SC1) ⊢ uσ]]$;
            ...
            Then $(Θ'  ⊢ SC2) ⊢ uσ'$ and $(Θ'  ⊢ SC1) ⊢ uσ'$ 
            holds and since $[[(Θ  ⊢  SC1) ⊢ uσ]]$ and $[[Θ ⊢ uσ' ≈ uσ]]$.
            ...
            \begin{enumerate}
                ...
                \item let us take an arbitrary $[[Θ ⊢ uσ0]]$ and $[[Γ ⊢ iM0]]$
                    ...
                    This way,
                    \begin{itemize}
                        \item $[[Θ ⊢ uσ' ≈ uσ0]]$ holds as noted above;
                        \item $[[(Θ' ⊢ SC1) ⊢ uσ']]$ holds because $[[(Θ  ⊢ SC1) ⊢ uσ0]]$ and 
                            $[[Θ ⊢ uσ' ≈ uσ0]]$, 
                            and $[[(Θ'  ⊢ SC1) ⊢ uσ']]$ together with $[[(Θ'  ⊢ SC2) ⊢ uσ']]$  
                            implies $[[(Θ'  ⊢ SC) ⊢ uσ']]$ by the completeness of constraint merge 
        ...
        \item \ruleref{\ottdruleDTEmptyAppLabel}\\
            ...
            \begin{enumerate}
                ...
                \item $[[Θ ⊢ uσ' ≈ uσ1]]$ holds by reflexivity of equivalence,
