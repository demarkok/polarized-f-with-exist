...
\begin{proof}
    ...
    \begin{caseof}
        ...
        \item \ruleref{\ottdruleATCVarLetLabel}
            We are proving that if
            $[[Γ; Φ ⊨ let x : iP = c ; c' : iN]]$
            then
            $[[Γ ; Φ ⊢ let x : iP = c ; c' : iN]]$ and 
            $[[Γ ⊢ iN]]$.
            ...
            \begin{enumerate}
                \item $[[Γ; Φ ⊨ c : iM]]$, 
                    ...
                    $[[Γ ⊢ iM]]$ and $[[Γ; Φ ⊢ c : iM]]$;
                \item $[[Γ;· ⊨ uM ≤ ↑iP ⫤ ·]]$, 
                    which by the soundness of negative subtyping (\cref{lemma:neg-subt-soundness})
                    means $[[Γ ⊢ iM ≤ ↑iP]]$;
                \item $[[Γ; Φ, x:iP ⊨ c' : iN]]$,
                    which by the induction hypothesis implies
                    $[[Γ ⊢ iN]]$ and $[[Γ; Φ, x:iP ⊢ c' : iN]]$.
            \end{enumerate}
            This way, $[[Γ; Φ ⊢ let x : iP = c ; c' : iN]]$ holds by
            \ruleref{\ottdruleDTCVarLetLabel}.
        ...
        \item \ruleref{\ottdruleATAppLetAnnLabel}
            ...
            $[[ Γ ; Φ ⊢ iM ● args ⇒> [uσ]uM' ]]$
            And again, by the soundness of negative subtyping (\cref{lemma:neg-subt-soundness})
            applied to $[[Γ; Θ ⊨ uM' ≤ ↑iP ⫤ SC2]]$,
            we have
            $[[Γ ⊢ [uσ]uM' ≤ ↑iP]]$.
            ...
            \begin{enumerate}
                ...
                \item $[[Γ; Φ ⊢ iM ● args ⇒> [uσ]uM']]$ holds as noted above,
                \item $[[Γ ⊢ [uσ]uM' ≤ ↑iP]]$ by soundness of negative subtyping,
                                ...
                                \item Let us prove $[[ [σ0][uσ]uN = [uσ1][â⁺*/pas]uN]]$
                                    ...
                                    \begin{align*} 
                                        [[ [σ0][uσ]uN  ]] 
                                            ...
                                            &\phantom{{} = {}} \text{by definition of $[[σ0]]$}\\
                                            &= [[ [uσ0][uσ|{â⁺*}][â⁺*/pas][uσ|uv uN]uN ]] \\
                                            &\phantom{{} = {}} \text{by \cref{lemma:subst-restr-uv}}\\
                                            &= [[ [uσ0][uσ|{â⁺*}][uσ|uv uN][â⁺*/pas]uN ]] \\
                                            &\phantom{{} = {}} \text{$[[uv uN ∩ {â⁺*} = ∅]]$ and 
                                                    $[[{pas} ∩ Γ = ∅]]$}\\
                                            &= [[ [uσ|{â⁺*}][uσ|uv uN][â⁺*/pas]uN ]] \\
                                            &\phantom{{} = {}} \text{since $[[ [uσ|{â⁺*}][uσ|uv uN][â⁺*/pas]uN ]]$
                                                is ground}\\
                                            ...
                                            &\phantom{{} = {}} \text{also by \cref{lemma:subst-restr-uv}}\\
                                            &= [[ [(uσ0 ○ uσ)|Ξ ∪ uv uN ∪ uv uM][â⁺*/pas]uN ]] \\
                                            &\phantom{{} = {}} \text{$[[ [uσ|Ξ ∪ uv uN ∪ uv uM][â⁺*/pas]uN]]$ is ground}\\
                                            &= [[ [uσ1][â⁺*/pas]uN ]] \\
                                            &\phantom{{} = {}} \text{by definition of $[[uσ1]]$}\\
                                        \end{align*} 
                                \item $[[ [uσ]uM = [uσ1]uM]]$
...
\begin{proof}
    ...
    \begin{caseof}
        ...
        \item \ruleref{\ottdruleDTTLamLabel}\\
            ...
            \begin{align*} 
                [[ pcs'' ]] &= [[ord {α⁺,pcs'} in nf(nf(iM))]] \\
                            &= [[ord {α⁺,pcs'} in nf(iM)]]\\
                            &\phantom{{} = {}} \text{by idempotence (\cref{lemma:norm-idemp})}\\
                            &= [[ord {α⁺} ∪ {pbs} ∩ fv nf(iM) in nf(iM)]] \\
                            &\phantom{{} = {}} \text{by definition of $[[pcs']]$ and \cref{lemma:ord-soundness}}\\
        ...
        \item \ruleref{\ottdruleDTCVarLetLabel}\\
            Then we prove that
            $[[Γ; Φ ⊢ let x:iP = c; c' : iN]]$
            implies
            $[[Γ; Φ ⊨ let x:iP = c; c' : nf(iN)]]$.
            ...
            \begin{enumerate}
                ...
                \item $[[Γ; Φ ⊢ c : iM]]$,
                    ...
                    $[[Γ; Φ ⊨ c : nf(iM)]]$;
                \item $[[Γ ⊢ iM ≤ ↑iP]]$, 
                    which by \cref{corollary:nf-sound-wrt-subt-equiv}
                    and \cref{lemma:subtyping-transitivity} implies
                    $[[Γ ⊢ nf(iM) ≤ ↑iP]]$,
                    that is 
                    $[[Γ ⊢ [·]nf(uM) ≤ ↑iP]]$.
                    Then by the completeness of subtyping
                    (\cref{lemma:neg-subt-completeness}), we have
                    $[[Γ ; · ⊨ nf(uM) ≤ ↑iP ⫤ ·]]$;
                \item $[[Γ; Φ, x:iP ⊢ c' : iN]]$,
                    and by the induction hypothesis,
                    $[[Γ; Φ, x:iP ⊨ c' : nf(iN)]]$.
            ...
            Together, these premises imply
            $[[Γ; Φ ⊨ let x:iP = c; c' : nf(iN)]]$ by \ruleref{\ottdruleATCVarLetLabel}.
        ...
        \item \ruleref{\ottdruleDTAppLetAnnLabel}\\
            ...
            \begin{enumerate}
                ...
                \item $[[Γ ; Φ ⊢ iM ● args ⇒> iM']]$. 
                    ...
                    $[[uM0]]$, $[[Θ]]$, and $[[SC1]]$ such that
                    (noting that $[[iM]]$ is ground):
                    \begin{enumerate}
                        \item $[[ Γ; Φ; · ⊨ nf(uM) ● args ⇒> uM0 ⫤ Θ; SC1 ]]$,
                            where by the soundness, $[[Γ; dom(Θ) ⊢ uM0]]$ and $[[Θ ⊢ SC1]]$.
                        \item for any $[[Γ ⊢ iM'']]$ 
                            such that $[[Γ; Φ ⊢ nf(iM) ● args ⇒> iM'']]$
                            there exists $[[uσ]]$ such that 
                            \begin{enumerate}
                                \item $[[ Θ ⊢ uσ : uv uM0 ]]$, $[[ Θ ⊢ uσ : SC1 ]]$, and 
                                \item $[[Γ ⊢ [uσ]uM0 ≈ iM'']]$,
                            \end{enumerate}
                            ...
                            $[[ Θ ⊢ uσ0 : SC1]]$,
                            $[[Γ ⊢ [uσ0]uM0 ≈ iM']]$.
                            % Since $[[uM0]]$ is normalized and free of negative algorithmic variables,
                            % the latter equivalence means
                            % $[[uM0 = ↑uQ0]]$ for some $[[uQ0]]$, and $[[Γ ⊢ [uσ0]uQ0 ≈ iQ]]$.
                    \end{enumerate}
                \item $[[Γ ⊢ iM' ≤ ↑iP]]$,
                    and by transitivity, since $[[Γ ⊢ [uσ0]uM0  ≈ iM']]$,
                    we have $[[Γ ⊢ [uσ0]uM0 ≤ ↑iP]]$.
                    
                    Let us apply \cref{lemma:neg-subt-completeness} to 
                    $[[Γ ⊢ [uσ0]uM0 ≤ ↑iP]]$ and obtain
                    $[[Θ ⊢ SC2]]$ such that 
                    \begin{enumerate}
                        \item $[[Γ ; Θ ⊨ [uσ0]uM0 ≤ ↑iP ⫤ SC2]]$ and
                        \item $[[ Θ   ⊢ uσ0 : SC2 ]]$.
                    \end{enumerate}
                \item $[[Γ; Φ, x:iP ⊢ c : iN]]$, 
                    and by the induction hypothesis,
