...
\begin{lemma}[Subtyping context irrelevance]
...
\begin{proof}
  ...
  Suppose that the judgement is inferred by \ruleref{\ottdruleDOneExistsLabel}.
...
\begin{lemma}[Weakening of subtyping context]
