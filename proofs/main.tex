...
\input{\genDir/tex/wf-statements.tex}

\subsection{Substitution}
\input{\genDir/tex/subst-statements.tex}

\subsection{Declarative Subtyping}
\input{\genDir/tex/decl-subtyping-statements.tex}

\subsection{Equivalence}
\label{sec:decl-equiv-statements}
\input{\genDir/tex/equiv-statements.tex}

\subsection{Variable Ordering}
\input{\genDir/tex/ord-statements.tex}

\subsection{Normaliztaion}
\input{\genDir/tex/norm-statements.tex}

\section{Declarative Typing}
\input{\genDir/tex/decl-typing-statements.tex}

\section{Relation to \systemf}
\input{\genDir/tex/translation-statements.tex}

\section{Theorem Statements: Algorithmic}

\subsection{Algorithmic Type Well-formedness}
\input{\genDir/tex/wf-algo-statements.tex}

\subsection{Algorithmic Substitution}
\input{\genDir/tex/subst-algo-statements.tex}

\subsection{Algorithmic Normalization}
\input{\genDir/tex/norm-alg-statements.tex}

\subsection{Algorithmic Equivalence}
\input{\genDir/tex/equiv-alg-statements.tex}

\subsection{Unification Constraint Merge}
\input{\genDir/tex/unif-constraint-merge-statements.tex}

\subsection{Unification}
\input{\genDir/tex/unification-statements.tex}

\subsection{Anti-unification}
\input{\genDir/tex/au-statements.tex}

\subsection{Upper Bounds}
\label{sec:alg-upper-bounds-statements}
\input{\genDir/tex/lub-statements.tex}

\subsection{Upgrade}
\label{sec:upgrade-statements}
\input{\genDir/tex/upgrade-statements.tex}

\subsection{Constraint Satisfaction}
\input{\genDir/tex/constraint-sat-statements.tex}

\subsection{Positive Subtyping}
\input{\genDir/tex/alg-pos-subtyping-statements.tex}

\subsection{Subtyping Constraint Merge}
\input{\genDir/tex/constraint-merge-statements.tex}

\subsection{Negative Subtyping}
\input{\genDir/tex/alg-neg-subtyping-statements.tex}

\subsection{Singularity and Minimal Instantiation}
\input{\genDir/tex/singularity-statements.tex}

\subsection{Correctness of the Typing Algorithm}
\input{\genDir/tex/alg-typing-statements.tex}
...
\section{Relation to \systemf}
\input{\genDir/tex/translation-proofs.tex}
