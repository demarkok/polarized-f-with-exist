...
\begin{definition}[Variable Algorithmization]
  ...
  Then $[[ nuas/nas ]]$ is a substitution turning each $[[αi⁻]]$ from $[[nas]]$ into 
  $[[αî⁻]]$ from $[[nuas]]$.
  Positive algorithmization $[[ puas/pas ]]$
  is defined symmetrically.
\end{definition}
...
\begin{proof}
  ...
  \emph{unification} constraint entries by \cref{lemma:merge-matching-entries-is-well-defined}.
\end{proof}
...
\section{Properties of the Declarative System}
...
\section{Properties of the Algorithmic System}
