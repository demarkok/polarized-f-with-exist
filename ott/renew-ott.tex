...
\renewcommand{\ottdefnLUBNsubLabeled}[1]{\begin{ottdefnblock}[#1]{\ottdefnHeaderLUBNsub}{\ottcom{Least Upper Bound}}
\ottusedrule{\ottdruleLUBExistsLabeled{}}
\ottusedrule{\ottdruleLUBVarLabeled{}}
\ottusedrule{\hspace{-.8cm}\ottdruleLUBShiftLabeled{}}
\end{ottdefnblock}}
...
\renewcommand{\ottdefnATPInfLabeled}[1]{
...
\renewcommand{\ottdefnATSpinInfLabeled}[1]{\begin{ottdefnblock}[#1]{\ottdefnHeaderATSpinInf}{\ottcom{Application typing}}
    ...
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleATArrowAppLabeled{}}
    \end{minipage}
...
\ottusedrule{\hspace{2em}\ottdruleAShiftDLabeled{}}
