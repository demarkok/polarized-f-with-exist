...
\renewcommand{\ottdefnDTNInfLabeled}[1]{\begin{ottdefnblock}[#1]{\ottdefnHeaderDTNInf}{\ottcom{Negative typing}}
    \begin{multicols}{2}
...
\renewcommand{\ottdefnDTSpinInfLabeled}[1]{\begin{ottdefnblock}[#1]{\ottdefnHeaderDTSpinInf}{\ottcom{Application typing}}
    \begin{multicols}{2}
...
\renewcommand{\ottdefnDTPInfLabeled}[1]{\begin{ottdefnblock}[#1]{\ottdefnHeaderDTPInf}{\ottcom{Positive typing}}
    \begin{multicols}{2}
...
\renewcommand{\ottdruleLUBEExistsName}[0]{($\exists^{\vee}$)}
...
\renewcommand{\ottdruleAForallLName}[0]{($\forall^{\subA}_{\text{L}}$)}
\renewcommand{\ottdruleAForallRName}[0]{($\forall^{\subA}_{\text{R}}$)}
