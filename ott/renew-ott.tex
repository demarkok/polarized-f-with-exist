...
\renewenvironment{ottdefnblock}[3][]{ \framebox{\mbox{#2}} \; #3 \\[0pt]}{}
\renewenvironment{ottfundefnblock}[3][]{ \framebox{\mbox{#2}} \; #3 \\[0pt]\begin{displaymath}\begin{array}{l}}{\end{array}\end{displaymath}}
...
\renewcommand{\ottkw}[1]{{\bf \texttt{#1}}}

\renewcommand{\ottdrule}[4][]{{\displaystyle\frac{\begin{array}{l}#2\end{array}}{#3}\;\ottdrulename{#4}}}


\newcommand{\ottdefnTELNLabeledTwoColumns}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderTELN}{\ottcom{Negative typing elaboration}}
        \begin{minipage}[t]{0.5\textwidth}
            \ottusedrule{\ottdruleTELtLamLabeled[#1]{}}
            \ottusedrule{\ottdruleTELReturnLabeled[#1]{}}
            \ottusedrule{\ottdruleTELNEquivLabeled[#1]{}}
        \end{minipage}%
        \begin{minipage}[t]{0.5\textwidth}
            \ottusedrule{\ottdruleTELTLamLabeled[#1]{}}
            \ottusedrule{\ottdruleTELVarLetLabeled[#1]{}}
            \ottusedrule{\ottdruleTELNAnnotLabeled[#1]{}}
        \end{minipage}
        \ottusedrule{\ottdruleTELAppLetLabeled[#1]{}}
        \ottusedrule{\ottdruleTELAppLetAnnLabeled[#1]{}}
        \ottusedrule{\ottdruleTELUnpackLabeled[#1]{}}
        \ottusedrule{\ottdruleTELCVarLetLabeled[#1]{}}
    \end{ottdefnblock}
}

\newcommand{\ottdefnTELPAppLabeled}[2][]{
    \begin{minipage}[t]{0.45\textwidth}
        \begin{ottdefnblock}[#2]{\ottdefnHeaderTELP}{\ottcom{Positive typing elaboration}}
            \ottusedrule{\ottdruleTELVarLabeled[#1]{}}
            \ottusedrule{\ottdruleTELThunkLabeled[#1]{}}
            \ottusedrule{\ottdruleTELPAnnotLabeled[#1]{}}
            \ottusedrule{\ottdruleTELPEquivLabeled[#1]{}}
        \end{ottdefnblock}
    \end{minipage}
    \begin{minipage}[t]{0.5\textwidth}
        \begin{ottdefnblock}[#1]{\ottdefnHeaderTELApp}{\ottcom{Application typing}}
        \ottusedrule{\ottdruleTELEmptyAppLabeled[#1]{}}
        \ottusedrule{\ottdruleTELArrowAppLabeled[#1]{}}
        \ottusedrule{\ottdruleTELForallAppLabeled[#1]{}}
        \end{ottdefnblock}
    \end{minipage}
}


\renewcommand{\ottdefnLUBNsubLabeled}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderLUBNsub}{\ottcom{Least Upper Bound}}
        \ottusedrule{\ottdruleLUBExistsLabeled[#1]{}}
        \ottusedrule{\ottdruleLUBVarLabeled[#1]{}}
        \ottusedrule{\hspace{-.8cm}\ottdruleLUBShiftLabeled[#1]{}}
    \end{ottdefnblock}
}


\newcommand{\ottdefnELLabeled}[1][]{
    \framebox{\mbox{\ottdefnHeaderELN}} \quad
        \framebox{\mbox{\ottdefnHeaderELP}}

        \begin{minipage}[t]{0.49\textwidth}
            \ottusedrule{\ottdruleELNVarLabeled[#1]{}}
            \ottusedrule{\ottdruleELShiftULabeled[#1]{}}
        \end{minipage}%
        \begin{minipage}[t]{0.49\textwidth}
            \ottusedrule{\ottdruleELPVarLabeled[#1]{}}
            \ottusedrule{\ottdruleELShiftDLabeled[#1]{}}
        \end{minipage}
        \ottusedrule{\ottdruleELArrowLabeled[#1]{}}
        \ottusedrule{\ottdruleELExistsLabeled[#1]{}}
        \ottusedrule{\ottdruleELForallLabeled[#1]{}}
}

\newcommand{\ottdefnSFtyLabeledTwoColumns}[1][]{
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleSFtyVarLabeled[#1]{}}
        \ottusedrule{\ottdruleSFtytLamLabeled[#1]{}}
        \ottusedrule{\ottdruleSFtyAppLabeled[#1]{}}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleSFtyTLamLabeled[#1]{}}
        \ottusedrule{\ottdruleSFtyTAppLabeled[#1]{}}
    \end{minipage}
}

\newcommand{\ottdefnMININSTLabeled}[1][]{
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleSINGPUvarLabeled[#1]{}}
        \ottusedrule{\ottdruleSINGExistsLabeled[#1]{}}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleSINGSingLabeled[#1]{}}
    \end{minipage}
}

\newcommand{\ottdefnSINGLabeled}[1][]{
    % \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleSINGPEqLabeled[#1]{}}
        \ottusedrule{\ottdruleSINGNEqLabeled[#1]{}}
    % \end{minipage}%
    % \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleSINGSupVarLabeled[#1]{}}
        \ottusedrule{\ottdruleSINGSupShiftLabeled[#1]{}}   
    % \end{minipage}
}
...
\renewcommand{\ottrulehead}[3]{\multicolumn{3}{l}{#3}\ottprodnewline$#1$ & $#2$ }

\renewcommand{\ottdefnATNInfLabeled}[2][]{\begin{ottdefnblock}[#2]{\ottdefnHeaderATNInf}{\ottcom{Negative typing}}
    \begin{minipage}{0.45\textwidth}
        \ottusedrule{\ottdruleATNAnnotLabeled[#1]{}}
        \ottusedrule{\ottdruleATtLamLabeled[#1]{}}
        \ottusedrule{\ottdruleATTLamLabeled[#1]{}}
        \ottusedrule{\ottdruleATReturnLabeled[#1]{}}
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \ottusedrule{\ottdruleATVarLetLabeled[#1]{}}
        \ottusedrule{\ottdruleATCVarLetLabeled[#1]{}}
        \ottusedrule{\ottdruleATUnpackLabeled[#1]{}}
    \end{minipage}
    \ottusedrule{\ottdruleATAppLetAnnLabeled[#1]{}}
    \ottusedrule{\ottdruleATAppLetLabeled[#1]{}}
\end{ottdefnblock}}


\renewcommand{\ottdefnATPInfLabeled}[2][]{
    \begin{ottdefnblock}[#1]{\ottdefnHeaderATPInf}{\ottcom{Positive typing}}
        \begin{minipage}{0.29\textwidth}
            \ottusedrule{\ottdruleATVarLabeled[#1]{}}
        \end{minipage}
        \begin{minipage}{0.39\textwidth}
            \ottusedrule{\ottdruleATPAnnotLabeled[#1]{}}
        \end{minipage}
        \begin{minipage}{0.29\textwidth}
            \ottusedrule{\ottdruleATThunkLabeled[#1]{}}
        \end{minipage}
    \end{ottdefnblock}
}

\renewcommand{\ottdefnATSpinInfLabeled}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderATSpinInf}{\ottcom{Application typing}}
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleATEmptyAppLabeled[#1]{}}
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \ottusedrule{\ottdruleATArrowAppLabeled[#1]{}}
    \end{minipage}
    \ottusedrule{\ottdruleATForallAppLabeled[#1]{}}
    \end{ottdefnblock}
}
...
\renewcommand{\ottdefnDTNInfLabeled}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderDTNInf}{\ottcom{Negative typing}}
        \begin{minipage}[t]{0.49\textwidth}
            \ottusedrule{\ottdruleDTtLamLabeled[#1]{}}
            \ottusedrule{\ottdruleDTTLamLabeled[#1]{}}
            \ottusedrule{\ottdruleDTReturnLabeled[#1]{}}
            \ottusedrule{\ottdruleDTVarLetLabeled[#1]{}}
            \ottusedrule{\ottdruleDTCVarLetLabeled[#1]{}}
            \ottusedrule{\ottdruleDTNEquivLabeled[#1]{}}
        \end{minipage}
        \begin{minipage}[t]{0.49\textwidth}
            \ottusedrule{\ottdruleDTAppLetLabeled[#1]{}}
            \ottusedrule{\ottdruleDTAppLetAnnLabeled[#1]{}}
            \ottusedrule{\ottdruleDTUnpackLabeled[#1]{}}
            \ottusedrule{\hspace{-.5cm}\ottdruleDTNAnnotLabeled[#1]{}}
        \end{minipage}
    \end{ottdefnblock}}

\renewcommand{\ottdefnDTSpinInfLabeled}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderDTSpinInf}{\ottcom{Application typing}}
        \begin{minipage}{0.49\textwidth}
            \ottusedrule{\ottdruleDTEmptyAppLabeled[#1]{}}
            \ottusedrule{\ottdruleDTArrowAppLabeled[#1]{}}
        \end{minipage}
        \begin{minipage}{0.49\textwidth}
            \ottusedrule{\ottdruleDTForallAppLabeled[#1]{}}
        \end{minipage}
    \end{ottdefnblock}}

\renewcommand{\ottdefnDTPInfLabeled}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderDTPInf}{\ottcom{Positive typing}}
        \begin{minipage}{0.49\textwidth}
            \ottusedrule{\ottdruleDTVarLabeled[#1]{}}
            \ottusedrule{\ottdruleDTThunkLabeled[#1]{}}
        \end{minipage}
        \begin{minipage}{0.49\textwidth}
            \ottusedrule{\ottdruleDTPAnnotLabeled[#1]{}}
            \ottusedrule{\ottdruleDTPEquivLabeled[#1]{}}
        \end{minipage}
    \end{ottdefnblock}
}
...
\newcommand{\ottdefnsDTLabeled}[1][]{
    \ottdefnDTNInfLabeled[#1]{}
    \hfill\\
    \ottdefnDTPInfLabeled[#1]{}
    \hfill\\
    \newpage
    \ottdefnDTSpinInfLabeled[#1]{}
}
...
\renewcommand{\ottdefnAPsupLabeled}[2][]{
    \begin{ottdefnblock}[#2]{\ottdefnHeaderAPsup}{\ottcom{Positive supertyping}}
        \ottusedrule{\ottdruleAPVarLabeled[#1]{}}
        \ottusedrule{\hspace{-1cm}\ottdruleAExistsLabeled[#1]{}}
        \ottusedrule{\hspace{2em}\ottdruleAShiftDLabeled[#1]{}}
        \ottusedrule{\ottdruleAPUVarLabeled[#1]{}}
    \end{ottdefnblock}}

\renewcommand{\ottdefnAUAUN}[1]{
    \begin{ottdefnblock}[#1]{\ottdefnHeaderAUAUN}{}
    \begin{multicols}{2}
...
\renewcommand{\ottrulehead}[3]{\multicolumn{5}{@{}l}{#3}\ottprodnewline$#1$ & & $#2$ & & }
...
% Γ ; Φ ⊨ v : iP  
\renewcommand{\ottdruleATVarName}[0]{(\alghl{Var}$^{\text{inf}}$)}
\renewcommand{\ottdruleATThunkName}[0]{($\ngbox{\{\}}^{\text{inf}}$)}
\renewcommand{\ottdruleATPAnnotName}[0]{(\alghl{ann}$_+^{\text{inf}}$)}

% Γ ; Φ ⊨ c : iN 
\renewcommand{\ottdruleATtLamName}[0]{($\ngbox{\lambda}^{\text{inf}}$)}
\renewcommand{\ottdruleATTLamName}[0]{($\ngbox{\Lambda}^{\text{inf}}$)}
\renewcommand{\ottdruleATReturnName}[0]{(\alghl{ret}$^{\text{inf}}$)}
\renewcommand{\ottdruleATVarLetName}[0]{(\alghl{let}$^{\text{inf}}$)}
\renewcommand{\ottdruleATCVarLetName}[0]{(\alghl{let}$_{\text{c}}^{\text{inf}}$)}
\renewcommand{\ottdruleATAppLetName}[0]{(\alghl{let}$_@^{\text{inf}}$)}
\renewcommand{\ottdruleATAppLetAnnName}[0]{(\alghl{let}$_{:@}^{\text{inf}}$)}
\renewcommand{\ottdruleATUnpackName}[0]{(\alghl{let}$_{\exists}^{\text{inf}}$)}
\renewcommand{\ottdruleATNAnnotName}[0]{(\alghl{ann}$_-^{\text{inf}}$)}

% Γ ; Φ ; Θ1 ⊨ uN ● args ⇒> uM ⫤ Θ2 ; SC 
\renewcommand{\ottdruleATEmptyAppName}[0]{($\ngbox{\emptyset}_{[[●]][[⇒>]]}^{\text{inf}}$)}
\renewcommand{\ottdruleATArrowAppName}[0]{($\ngbox{\rightarrow}_{[[●]][[⇒>]]}^{\text{inf}}$)}
\renewcommand{\ottdruleATForallAppName}[0]{($\ngbox{\forall}_{[[●]][[⇒>]]}^{\text{inf}}$)}
