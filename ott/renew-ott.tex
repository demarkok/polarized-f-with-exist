...
\renewcommand{\ottdefnAPsup}[1]{\begin{ottdefnblock}[#1]{$ \Gamma  ;\,  \Theta   \vDash   \ngbox{ \mathcolor{positive}{P} }  \supA  \mathcolor{positive}{Q}   \Dashv   C $}{\ottcom{Positive supertyping}}
\ottusedrule{\ottdruleAPVar{}}
\ottusedrule{\hspace{-1cm}\ottdruleAExists{}}
\ottusedrule{\ottdruleAShiftD{}}
\ottusedrule{\ottdruleAPUVar{}}
\end{ottdefnblock}}
