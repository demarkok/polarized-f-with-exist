...
Substitution $[[uσ]]$ satisfies a constraint \emph{set}
...
\begin{itemize}
  ...
  \item However, if the body of the existential type is guarded by a shift $[[∃nas.↓iN]]$, it is
    singular if and only if $[[iN]]$ is equivalent to some $[[αi⁻ ∊ {nas}]]$ bound
    by the quantifier---see rule \ruleref{\ottdruleSINGSupShiftLabel}.
\end{itemize}
